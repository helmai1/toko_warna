...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container">
        <a class="navbar-brand" href="daftar-karyawan.php">Edit User</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a class="btn btn-outline-danger" href="daftar-karyawan.php"><i class="fa fa-sign-out-alt"></i></a></li>
            </ul>
        </div>
      </div>
    </nav>
              ...
              <div class="card-body">
                <form class="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="level" class="form-control" name="level" placeholder="Enter Level" value="<?php echo $row['level']; ?>">
                    </div>
                    <div class="form-group">
