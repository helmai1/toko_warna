		...
		<div class="col-md-12">
			...
			<div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title">Tabel Pengelola</h3>
				</div>
				<div class="panel-body">
					<table class="table">
						<thead>
							<tr><th>id</th><th>Foto</th><th>Nama</th><th>Username</th><th>Password</th><th>Level</th><th>Action</th></tr>
						</thead>
						<tbody>
						<?php
                          ...
                          <tr>
                            ...
                            <td class="text-center">
							  ...
							  <a href="user-edit.php?id=<?php echo $row['id'] ?>" button type="button" class="btn btn-primary ">Edit</a>
                              <a href="daftar-karyawan.php?delete=<?php echo $row['id'] ?>" type="button" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?')">Delete</a>
                            </td>
                          </tr>
                          <?php
                              }
